/*
  # Database Schema Setup with Error Prevention
...
BEGIN
  ...
  DROP POLICY IF EXISTS "Utilizatorii pot gestiona propriul profil." ON user_profiles;
  ...
  DROP POLICY IF EXISTS "Utilizatorii pot gestiona propriile profile de brand." ON brand_profiles;
  ...
  DROP POLICY IF EXISTS "Utilizatorii pot gestiona propriul abonament." ON subscriptions;
  ...
  DROP POLICY IF EXISTS "Utilizatorii pot gestiona propriile planuri de marketing." ON marketing_plans;
  ...
  DROP POLICY IF EXISTS "Utilizatorii pot gestiona propriile postari programate." ON scheduled_posts;
  ...
  DROP POLICY IF EXISTS "Utilizatorii pot gestiona propriile recomandari AI." ON ai_recommendations;
EXCEPTION
