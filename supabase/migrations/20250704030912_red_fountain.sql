/*
  # Fix is_user_admin function and related functions

  1. Functions
    - Drop existing is_user_admin function if it exists
    - Create new is_user_admin function with correct parameter name
    - Update get_user_stats function to use the new is_user_admin function
    - Update check_user_limits function to use the new is_user_admin function
...
DROP FUNCTION IF EXISTS check_user_limits(uuid, text);

-- Create the is_user_admin function with correct parameter name
...
-- Create increment_plans_generated function
...
-- Create increment_content_generated function
